...
import { ArrowLeft, Share2, Flag, ChevronDown, Calendar, MapPin, Mail, Link2, MessageCircle, Repeat2, Eye, ThumbsUp, ThumbsDown, MoreHorizontal, X } from "lucide-react";
            ...
            <div className="flex items-center justify-between">
              ...
              {!isOwner && (
                <button onClick={handleSubscribe} disabled={subscribing}
                  ...
                  style={{
                    background: subscribed ? "rgba(255,255,255,0.07)" : "linear-gradient(135deg, #3D5AFE, #7B5CFF)",
